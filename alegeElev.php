...
<br><br>
    ...
    <h1 class="pep">CATALOG</h1>
        ...
        ?>
            <form action="verificaElev.inc.php" method="post" autocomplete="on">
            <input type="hidden" name="idScoala" value=<?php echo $idScoala ?>>
            <input type="hidden" name="clasaElev" value=<?php echo $numeClasa ?>>
                <input class="rubrici" type="text" name="emailElev" id="emailElev" placeholder="emailElev" required>
