    ...
    <h1 class="pep">CATALOG</h1>
        ...
        <?php
            if(isset($_GET["error"]))
            {
                ...
                {
                    echo "<span style=' font-size:35px; display:flex; justify-content:center; padding-top:1rem;'>Nu există acest elev</span>";
                }
        ...
        ?>
            <form action="verificaElevPtAfisareNote.inc.php" method="post" autocomplete="on">
            <input type="hidden" name="clasaElev" value=<?php echo $clasaElev ?>>
